...
public class MagicSutroFilter extends GPUImageFilter{
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(App.getContext(), "filter/vignette_map.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(App.getContext(), "filter/sutrometal.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(App.getContext(), "filter/softlight.png");
				inputTextureHandles[3] = OpenGlUtils.loadTexture(App.getContext(), "filter/sutroedgeburn.png");
				inputTextureHandles[4] = OpenGlUtils.loadTexture(App.getContext(), "filter/sutrocurves.png");
		    }
	    });
	}
}