...
public class MagicRiseFilter extends GPUImageFilter{
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(App.getContext(), "filter/blackboard1024.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(App.getContext(), "filter/overlaymap.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(App.getContext(), "filter/risemap.png");
		    }
	    });
	}
}