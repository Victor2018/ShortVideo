...
public class MagicTenderFilter extends GPUImageFilter{
	...
	public MagicTenderFilter(){
		super(GPUImageFilter.NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.tender));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(App.getContext(), "filter/bluevintage_mask1.jpg");
		    }
	    });
	}
}
