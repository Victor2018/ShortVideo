...
package com.victor.video.library.record.video;
...
import com.victor.video.library.gpufilter.basefilter.MagicCameraInputFilter;
import com.victor.video.library.record.gles.EglCore;
        ...
        public void handleMessage(Message inputMessage) {
            ...
            switch (what) {
                ...
                case MSG_STOP_RECORDING:
                    Log.e(TAG," receive MSG_STOP_RECORDING msg.......................3333.");
...
//    private MagicFilterType type = MagicFilterType.NONE;
    private AFilter mShowFilter=new NoFilter(App.getContext().getResources());
